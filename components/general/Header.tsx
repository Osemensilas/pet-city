...
const Header = () => {
    ...
    return ( 
        ...
        <header className="h-[100px] w-screen px-4 sm:px-10">
            ...
            <div className={`h-[100vh] sm:h-[50%] w-full flex flex-col sm:flex-row items-start sm:items-center justify-between
            ${showNav ? "absolute top-0 left-0 z-5" : "hidden sm:block"}
            `}>
