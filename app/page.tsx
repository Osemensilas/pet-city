...
const HomePage = () => {
  ...
  const [activeImg, setActiveImg] = useState("/image/hero1.jpg");
  ...
  useEffect(() => {
    ...
    setInterval(() => {
      ...
      if (countDown === 1){
        setActiveImg("/image/hero1.jpg");
        setActiveIndex(1);
      }
      if (countDown === 2){
        setActiveImg("/image/hero3.jpg");
        setActiveIndex(2);
      }
      if (countDown === 3){
      ...
      if (countDown === 4){
        setActiveImg("/image/hero4.jpg");
        setActiveIndex(4);
      }
      if (countDown === 5){
        setActiveImg("/image/hero6.jpg");
        setActiveIndex(5); 
      }
    }, 5000)
  },[]);
