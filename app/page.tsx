      ...
      <div className="h-full w-full flex rounded bg-accent">
        <div className="w-1/2 h-full flex justify-center flex-col gap-10 px-10">
          ...
          <form className="h-max w-full">
            <input className="h-10 w-[75%] border border-grey px-5 outline-none" placeholder="Enter email address" type="text" name="email" id="email" />
        ...
        <div className="relative w-1/2 h-full">
          <Image src={"/pet-doc.jpg"} fill alt="pharmacy image" className="rounded-tr rounded-br" />
        </div>
      </div>
    </section>
    <Faqs />
